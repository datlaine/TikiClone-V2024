...
//                     <img src={require(`${list.isLabel[1].label}`)} className={style[`${list.isLabel[2].nameLabel}`]} alt='' />
//                   )}

//                   {list.astraLabel[0].checkAstra && (
//                     <img src={require(`${list.astraLabel[1].hinhAnhAstra}`)} className={style[`${list.astraLabel[2].nameLabel}`]} alt='' />
//                   )}
...
//                             />
//                           </div>
//                           <span style={{ width: 1, height: 9, margin: '0 8px', backgroundColor: 'rgb(199, 199, 199)' }}></span>
//                         </div>
//                       ) : (
//                         ''
//                       )}
...
//                       {/** 1 */}
//                       <p className={list.isPromote[0].checkPromote ? `${style.isPrice} ${style.promote}` : style.isPrice}>
//                         {list.isPrice}{' '}
//                         <span className={style.promoteSub}>{list.isPromote[0].checkPromote ? `${list.isPromote[1].promote}%` : ''}</span>
//                       </p>
//                       {/** 2 */}
...
//                       )}
//                       {!list.isShip[0].checkShipNOW &&
//                         `Giao vào thứ ${list.isShip[1].shipDate || 'error'}, ngày ${list.isShip[2].shipDay || 'error'}`}{' '}
//                     </p>
//                   </div>
//                 </a>
//               </div>
