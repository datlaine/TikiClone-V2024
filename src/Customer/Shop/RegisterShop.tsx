    ...
    return (
        <div className='w-full'>
            ...
            <FormProvider {...registerShop}>
                ...
                >
                    <InputText<TFormRegisterShop> LabelMessage='Tên của Shop' placehorder='Nhập tên của Shop' FieldName='shop_name' />
                    ...
                    {imagePreview && (
                        <div className='w-full flex justify-center'>
                            ...
                            <button className='bg-slate-700 rounded-lg px-[16px] py-[12px] text-white ml-[20px]' onClick={openModalPreview}>
                                Xem trước
                            </button>
                        </div>
                    )}
                    ...
                    {imageAvatar && (
                        <button className='bg-slate-700 rounded-lg px-[16px] py-[12px] text-white' onClick={handleDeleteImageCurrent}>
                            {'Chọn lại'}
                        </button>
                    )}
