...
export default function Buy() {
      ...
      const handleAddProduct = () => {
            if (!user) {
                  ...
                  let giamGia = sanPham?.isPromote[0].checkPromote === true ? sanPham?.isPrice - (sanPham?.isPrice / 100) * maGiamGia : 0
                                                            ...
                                                            <div className='flex flex-1 gap-3 justify-between'>
                                                                  <div className='flex flex-col gap-1 items-center justify-center'>
                                                                        ...
                                                                        <p className='flex-1 text-sm  justify-center  break-words'>
                                                                              Hoàn toàn <span className='text-slate-950'>111%</span> nếu là
                                                                              hàng giả
                                                                        </p>
                                                                  </div>
                                                                  <div className='flex flex-col gap-1 items-center justify-center'>
                                                                  ...
                                                                  <div className='flex flex-col gap-1 items-center justify-center'>
                                                                        ...
                                                                        <p className='flex-1 text-sm justify-center   break-words'>
                                                                              Đổi trả trong <span className='text-slate-950'>30 ngày</span>{' '}
                                                                              nếu sp lỗi
                                                                        </p>
                                                                  </div>
                                                            </div>
