...
import { useQuery, useMutationState, useMutation } from '@tanstack/react-query'
        ...
        >
            ...
            >
                ...
                <div className='w-full h-[250px] rounded-full mt-[30px] flex justify-center'>
                    <img src={user.avatar?.secure_url || user.avartar_url_default || ''} alt='user_avatar' className='w-[250px] h-full ' />
                </div>
