...
function BoxLogin(props) {
  ...
  const handleModeLoginOrResister = (
    onMode,
  ) => {
            ...
            >
              ...
              <div
                className={`p-[20px] w-full 2xl:flex-[0_0_60%] ${
                  onModeResister
                    ? 'lg:py-[30px] 2xl:py-[45px]'
                    : 'lg:py-[10px] 2xl:py-[15px]'
                }`}
              >
                {onModeResister ? (
                  <Resister
                    handleModeLoginOrResister={
                      handleModeLoginOrResister
                    }
                  />
                ) : (
              ...
              <div className='hidden bg-gradient-to-t from-sky-400 to-cyan-400 2xl:flex-[0_0_40%] 2xl:flex 2xl:flex-col  2xl:items-center 2xl:gap-8 2xl:py-[35px]'>
                <img
                  src={require('../imageLogin.png')}
                  alt=''
                  className='w-[203px] h-[203px]'
                />
                <div className='2xl:flex flex-col flex-1 justify-center'>
                  <p className='font-bold text-[#0b74e5] text-xl'>
                    Mua sắm tại Tiki
                  </p>
                  <p className='text-[#0b74e5]'>
                    Siêu ưa đãi mỗi ngày
                  </p>
                </div>
              </div>
            </div>
...
const mapDispatchToProps = (
  ...
  doCloseBoxLogin: () =>
    store.dispatch(doCloseBoxLogin()),
})
