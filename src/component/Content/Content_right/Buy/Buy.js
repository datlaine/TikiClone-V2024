    ...
    <div className={style.buy}>
      ...
      <div className={style.wrapperBuy}>
        <div className={style.pathTitle}>
          ...
          <span className={style.current} title={state.name}>
            {state.name}
          </span>
        </div>
        <div className={style.products}>
          <div className={style.productsImg}>
            <img src={require(`../DanhSachSanPham${state.data.hinhAnh.slice(1)}`)} alt='' />
          </div>
          ...
          <div className={style.productsInfo}>
            <div className={style.officalNameVoteBought}>
              ...
              <div className={style.name}>
                <span className={style.nameStyle} title={state.name}>
                  {state.data.name}
                </span>
              </div>
              <p className={style.vote}>
                ...
                <span
                  className={checkNumberVote ? style.bought : `${style.bought} ${style.boughtFix}`}
                >
                  {isBought}
                </span>
              </p>
      ...
      <MiniDanhSach colums={[1, 7]} rows={[1, 2]} call={state.call && state.call} />
    </div>
  )
}
