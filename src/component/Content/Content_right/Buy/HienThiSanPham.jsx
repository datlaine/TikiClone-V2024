      ...
      isPricePromote:
        Number(
          sanPham.current.isPrice -
            (sanPham.current.isPrice / 100) * Number(sanPham.current?.isPromote[1]?.promote) * -1,
        ) || 0,
    }))
  }, [])
          ...
          <div className={style.productsInfo}>
            <div className={style.officalNameVoteBought}>
              ...
              <div className={style.vote}>
                ...
                <span style={{ width: 1, height: 12, margin: '0 8px', backgroundColor: 'rgb(199, 199, 199)' }}></span>
