...
const PaymentItem = (props: TProps) => {
      ...
      return (
            <div className='w-full min-h-[135px] h-max relative z-[2] border-[1px] border-slate-300 rounded-lg text-[13px]'>
                  ...
                  <div className='mt-[30px]  px-[25px] flex flex-col gap-[8px]'>
                        <div className='flex justify-between items-start h-[40px]'>
                              ...
                              <div className='w-[300px] h-[40px] bg-slate-300 rounded-md flex items-center px-[16px] gap-[8px] text-[14px]'>
                                    <Bike />
                                    <span>Được giao bởi Đạt</span>
                              </div>
                        </div>

                        <div className='h-[80px] flex mb-[16px]'>
                              <div className='min-w-[260px] h-[50px] flex gap-[16px] '>
                              ...
                              <div className='flex-1 flex h-[50px] items-end'>
                                    {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(cart.cart_product_price)}
                              </div>
                        </div>
                  </div>
            </div>
