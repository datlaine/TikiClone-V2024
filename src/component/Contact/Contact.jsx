...
import Avatar from './AvatarContact/avatar.jpg'
...
export default function Contact() {
  ...
  return (
    <div>
      <section class='max-h-[calc(100%-131px)] bg-white dark:bg-gray-900'>
        <div class='container px-6 py-10 mx-auto'>
          <div class='lg:flex lg:items-center'>
            <div class='lg:w-1/2 lg:mx-10'>
              ...
              <p class='mt-4 text-gray-500 dark:text-gray-400'>Thành công bởi lựa chọn - Trích Đại học Gia Định</p>

              <form class='mt-12' onSubmit={sendEmail} ref={form}>
                <div class='-mx-2 md:items-center md:flex'>
                  <div class='flex-1 px-2'>
                    <label class='block mb-2 text-sm text-gray-600 dark:text-gray-200'>Thông tin tài khoản</label>
                    <input
                      type='text'
                      placeholder='Lại Huỳnh Phát Đạt'
                      name='name'
            ...
            <div class='mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10'>
              ...
              <div class='mt-6 space-y-8 md:mt-8'>
                ...
                <p class='flex items-start -mx-2'>
                  ...
                  <span class='mx-2 text-gray-700 truncate w-72 dark:text-gray-400'>datlai304@gmail.com</span>
                </p>
              </div>
