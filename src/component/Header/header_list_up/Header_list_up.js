...
function Header_list_up() {
    ...
    return(
        <div id="header_list_up">
            <div className="logo">
                <img src="https://salt.tikicdn.com/ts/upload/e4/49/6c/270be9859abd5f5ec5071da65fab0a94.png" width="57px" height="40px" alt="" />
            </div>
            <form className="input" onSubmit={handleSubMit}>
                ...
                <input type="text" placeholder="Bạn tìm gì hôm nay"
                    ...
                    onClick={handleClick}
                />
                <button type='submit' className="btn-header" onClick={handleClick}>Tìm kiếm</button>
            ...
            <div id="nav">
                ...
                <div className="nav_item">
                    <img src="https://salt.tikicdn.com/ts/upload/41/28/7d/4713aa0d2855c5c770799f248692f0c5.png" alt="" />
                    <button>Astra</button>
                </div>
                <div className="nav_item">
