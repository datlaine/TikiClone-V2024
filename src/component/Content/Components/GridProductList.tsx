                    ...
                    <div className='h-full px-[10px] py-[5px]  flex flex-col gap-1'>
                        ...
                        <div className='basis-[30%] lg:basis-[35%] lg:grow bg-[yellow] flex flex-col gap-1 overflow-hidden'>
                            <p className='grow lg:basis-[65%] truncate  w-full bg-[orange]'>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas dignissimos quis fugit est cumque quidem
                                nesciunt ab doloribus reprehenderit accusamus magni impedit, nulla beatae suscipit, corrupti tenetur quia
                                pariatur quaerat! Quasi alias vitae iusto veritatis molestiae quod architecto saepe doloremque! Quod
                                voluptatum, unde officiis eos vero ducimus temporibus magni porro alias repellat minima inventore tempora?
                                Ad optio aliquid inventore autem. Dignissimos, sit nihil. Laboriosam cumque exercitationem consequuntur quo
                                quam accusantium minima, nostrum sapiente tempora distinctio quod pariatur libero inventore illo, ab error.
                                Ea qui similique cumque minima voluptatem? Dolorem, distinctio.
                            </p>
                            <p>8000000</p>
                        </div>
                                ...
                                <div className='h-full px-[10px] py-[5px] bg-white flex flex-col gap-1'>
                                    ...
                                    <div className='basis-[30%] lg:basis-[35%] lg:grow bg-[yellow] flex flex-col gap-1 overflow-hidden'>
                                        <p className='grow lg:basis-[65%] truncate  w-full bg-[orange]'>
                                            ...
                                            suscipit, corrupti tenetur quia pariatur quaerat! Quasi alias vitae iusto veritatis molestiae
                                            quod architecto saepe doloremque! Quod voluptatum, unde officiis eos vero ducimus temporibus
                                            magni porro alias repellat minima inventore tempora? Ad optio aliquid inventore autem.
                                            Dignissimos, sit nihil. Laboriosam cumque exercitationem consequuntur quo quam accusantium
                                            minima, nostrum sapiente tempora distinctio quod pariatur libero inventore illo, ab error. Ea
                                            qui similique cumque minima voluptatem? Dolorem, distinctio.
                                        </p>
                                        <p>8000000</p>
                                    </div>
                                    <div className='basis-[6%] lg:basis-[10%] bg-[gray]'>time</div>
